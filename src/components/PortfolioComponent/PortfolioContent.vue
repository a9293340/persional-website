...
<template>
  ...
  <div class="portfolio-content-mobile">
    ...
    <div class="content-zone">
      <div class="content">
        <div :class="['slogan', i18nFontFamily]">{{ $t('portfolio.slogan4') }}</div>
        <div v-for="item in props.tech" :key="item">
          <div :class="['slogan-content', `${i18nFontFamily}-title`]" v-if="item.type === 'title'">
            {{ item.content }}
          </div>
          <div
      ...
      <div class="content">
        <div :class="['slogan', i18nFontFamily]">{{ $t('portfolio.slogan3') }}</div>
        <div
          :class="['slogan-content', `${i18nFontFamily}-content`]"
      ...
      <div class="content">
        <div :class="['slogan', i18nFontFamily]">{{ $t('portfolio.slogan1') }}</div>
        <div :class="['slogan-content', `${i18nFontFamily}-content`]">{{ props.summary }}</div>
      </div>
      <div class="content">
        <div :class="['slogan', i18nFontFamily]">{{ $t('portfolio.slogan2') }}</div>
        <div :class="['slogan-content', `${i18nFontFamily}-content`]">{{ props.feature }}</div>
      </div>
    </div>
  </div>
...
.portfolio-content-mobile {
  ...
  .content-zone {
    @apply w-full h-3/5 overflow-auto scrollbar-thin;
    .content {
