...
<template>
  <div class="self-introduction">
    ...
    <div class="introduction">
      <div class="top">
        <div
          :class="['header-words', i18nFontFamily, { pick: pick === 'information' }]"
          @click="pickInfo('information')"
        >
          {{ $t('about.information') }}
        </div>
        <div
          :class="['header-words', i18nFontFamily, { pick: pick === 'interest' }]"
          @click="pickInfo('interest')"
        >
          {{ $t('about.interest') }}
        </div>
        <div
          :class="['header-words', i18nFontFamily, { pick: pick === 'experience' }]"
          @click="pickInfo('experience')"
        >
          {{ $t('about.experience') }}
        </div>
        <div
          :class="['header-words', i18nFontFamily, { pick: pick === 'technology' }]"
