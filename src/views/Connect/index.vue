    ...
    <div class="main">
      <div class="box">
        ...
        <div class="list">
          ...
          <a href="https://github.com/a9293340?tab=repositories" target="_blank">
            <el-icon :size="60" color="#0072E3">
              <i-mdi:github />
            </el-icon>
          </a>
...
.contact {
  @apply relative;
  .main {
    @apply absolute xl:left-10 xl:bottom-40 xl:z-50 xl:w-1/3  w-10/12 h-auto pt-3 left-1/2 -translate-x-1/2 xl:translate-x-0 bottom-20 bg-white bg-opacity-0 backdrop-blur-lg rounded-2xl p-0 xl:p-5 flex flex-col justify-center items-center;
    .list {
      ...
      span {
        @apply text-neutral-800 font-bold text-lg xl:text-2xl;
      }
    }
  }
}
